...
<header className="sticky top-0 left-0 w-full flex flex-col sm:flex-row items-center px-6 py-4 bg-black bg-opacity-75 z-10">
  ...
  <nav className="w-full lg:w-1/3 flex justify-evenly mt-2 sm:mt-0">
    <a href="#features" className="text-sm sm:text-lg text-white hover:text-gray-300 transition">
      Features
    </a>
    <a href="#about" className="text-sm sm:text-lg text-white hover:text-gray-300 transition">
      About
    </a>
      ...
      >
        ...
        <div className="lg:w-1/2 flex flex-col items-center lg:items-start lg:mx-auto lg:pl-24">
          ...
          <p className="text-3xl max-w-10xl leading-relaxed">
            ...
            <strong> SmartSight</strong> bridges this gap with an AI-powered
            multi-modal search system, delivering accurate and efficient results
